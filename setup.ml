...
(* OASIS_START *)
(* DO NOT EDIT (digest: b8894b6ab9b33ddf4b8486673a797b79) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("ppx_deriving_hardcaml", None);
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "HardCamlReedsolomon";
                           FindlibPackage
                             ("hardcaml-framework.console", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "s\017\139\194g\0121D\199\t\151[|.\153\157";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
