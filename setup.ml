...
(* OASIS_START *)
(* DO NOT EDIT (digest: b9ba92c617dfd89362848122766fb2c9) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Andy Ray"];
          homepage = Some "https://github.com/ujamjar/hardcaml-reedsolomon";
          synopsis = "HardCaml Reed-Solomon error correction CODEC";
          description =
            Some
              [OASISText.Para "HardCaml Reed-Solomon error correction CODEC"];
          categories = [];
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("reedsolomon", None)
                        ];
                   ...
                   {
                      lib_modules = ["Galois"; "Codec"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "hardcaml-reedsolomon";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build the web demo (requires hardcaml)";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "HardCamlReedsolomon";
                   ...
                   {exec_custom = true; exec_main_is = "encode.ml"});
               Executable
                 ({
                     cs_name = "syndromes";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "syndromes.ml"});
               Executable
                 ({
                     cs_name = "berlekamp";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "berlekamp.ml"});
               Executable
                 ({
                     cs_name = "chien";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "chien.ml"});
               Executable
                 ({
                     cs_name = "forney";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "forney.ml"});
               Executable
                 ({
                     cs_name = "decode";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "decode.ml"});
               Executable
                 ({
                     cs_name = "hcrsencode";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "HardCamlReedsolomon";
                           FindlibPackage ("hardcaml-examples.app", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = true; exec_main_is = "hcrsencode.ml"});
               Executable
                 ({
                     cs_name = "hcrsdecode";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = true; exec_main_is = "hcrsdecode.ml"});
               SrcRepo
                 ({
                     cs_name = "master";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/ujamjar/hardcaml-reedsolomon.git";
                      src_repo_browser =
                        Some
                          "https://github.com/ujamjar/hardcaml-reedsolomon";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "#'\199\005i\140\162\238\207}\1781\247b\243\226";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
