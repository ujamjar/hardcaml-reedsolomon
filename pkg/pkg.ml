...
let () = 
  Pkg.describe "hardcaml-reedsolomon" @@ fun c ->
  Ok (
    mlpack "src/HardCamlReedsolomon" @
    [Pkg.bin "test/hcrsencode" ~dst:"hardcaml-rsencode"; 
     Pkg.bin "test/hcrsdecode" ~dst:"hardcaml-rsdecode"]  
  )
